"""
This file is copied from greentreesnakes repository, the following content
on the top of the line is copied from the original repository's ReadMe file:

This is the source repository for Green Tree Snakes, a field guide to Abstract
